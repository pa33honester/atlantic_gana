                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group" id="supplier-id">
                                        ...
                                        <select name="supplier_id" required class="selectpicker form-control"
    ...
    <script type="text/javascript">
                ...
                success: function(data) {
                    if (data['number_of_user_account'] > 0 && data['number_of_user_account'] <=
                        ...
                        localStorage.setItem("message",
                            "You don't have permission to create another user account as you already exceed the limit! Subscribe to another package if you wants more!"
                        );
        ...
        $('input[type=submit]').on('click', function(e) {
            ...
            $.ajax({
                ...
                error: function(data) {
                    console.log(data);
                    alert('Error occurred! Please check the form data.');
                }
            });
        });
        ...
        $('select[name="role_id"]').on('change', function() {
            ...
            if (selectedRole == 'admin') {
                ...
                $('#supplier-id').hide(300);
                $('select[name="supplier_id"]').prop('required', false);
            } else if (selectedRole == 'special_supplier') {
                $('input[name="is_special"]').val(1);
