                        ...
                        <div class="form-group row">
                            ...
                            <div class="d-tc">
                                <div class="input-group" style="width:100%">
                                    <input type="text" class="daterangepicker-field form-control input-lg w-100"
        ...
        <ul class="nav nav-tabs ml-4 mt-3" role="tablist">
            ...
            <li class="nav-item">
                <a class="nav-link" href="#supplier-quotation" role="tab"
                    data-toggle="tab">{{ trans('Total Balance') }}</a>
            </li>
        </ul>
        ...
        function datatable_sum_sale(dt_selector, is_calling_first) {
            if (dt_selector.rows('.selected').any() && is_calling_first) {
                ...
                for (var _i = 5; _i < 9; _i++) {
                    $(dt_selector.column(_i).footer()).html(dt_selector.cells(rows, _i, {
                        page: 'current'
                    }).data().sum().toFixed({{ $general_setting->decimal }}));
                }
            } else {
                for (var _i = 5; _i < 9; _i++) {
                    $(dt_selector.column(_i).footer()).html(dt_selector.column(_i, {
                        page: 'current'
                    }).data().sum().toFixed({{ $general_setting->decimal }}));
                }
            }
