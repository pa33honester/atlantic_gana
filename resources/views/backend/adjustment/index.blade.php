...
<section>
    <div class="container-fluid">
        @if(in_array("inbound-add", $all_permission) && $product_adjust_action == 'inbound')
            <a href="#" class="btn btn-info btn-add-adjust"><i class="dripicons-plus"></i> {{trans('Add Inbound')}}</a>&nbsp;
        @endif
        @if(in_array("outbound-add", $all_permission) && $product_adjust_action == 'outbound')
            <a href="#" class="btn btn-info btn-add-adjust"><i class="dripicons-plus"></i> {{trans('Add Outbound')}}</a>&nbsp;
        @endif
        <div class="card mt-3">
            <div class="card-body">
                <div class="row mt-2">
        ...
        <div role="document" class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <iframe src="" style="border:none;width:100%; height: 850px;" id="adjustment-iframe"></iframe>
                </div>
...
<script type="text/javascript">
    ...
    $(document).ready( function(){
        ...
        $('.btn-add-adjust').on('click', function(){
            $('#adjustment-iframe').attr('src', "{{ url('adjustment/create/'.$product_adjust_action) }}");
