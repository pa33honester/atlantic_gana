                            ...
                            <div class="row">
                                ...
                                <div id="width" class="col-md-4">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="width" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="length" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="length" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="height" class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="height" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="cost" class="col-md-4 hidden">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" class="form-control" step="any" value="0">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 hidden">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="wholesale_price" class="form-control" step="any" value="0">
                                    </div>
                                </div>
                                <div class="col-md-4 hidden">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="daily_sale_objective" class="form-control" step="any" value="0">
                                    </div>
                                </div>
