                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="supplier_id" class="selectpicker form-control" data-live-search="true" title="Select supplier..." value="{{$lims_product_data->supplier_id}}">
                                ...
                                <div id="unit" class="col-md-12 hiddens">
                                    <div class="row ">
                                        <div class="col-md-4">
                                ...
                                <div id="width" class="col-md-4">
                                     <div class="form-group">
                                        <label>{{trans('Product Width')}} *</strong> </label>
                                        <input type="number" name="width" value="{{$lims_product_data->width}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="length" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Product Length')}} *</strong> </label>
                                        <input type="number" name="length" value="{{$lims_product_data->length}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="height" class="col-md-4">
                                    <div class="form-group">
                                        <label>{{trans('Product Height')}} *</strong> </label>
                                        <input type="number" name="height" value="{{$lims_product_data->height}}" required class="form-control" step="any">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div id="cost" class="col-md-4 hiddens">
                                    <div class="form-group">
