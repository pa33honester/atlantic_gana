                        ...
                        <li class="nav-item">
                            ...
                            <ul class="right-sidebar">
                                ...
                                @if ($empty_database_permission_active)
                                    <li>
                                        <a onclick="emptyDatabase()" href="#"><i class="dripicons-stack"></i>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <?php
                            // Use $lims_user_list provided by view composer. Filter out current user if needed.
                            $lims_user_list = isset($lims_user_list) ? collect($lims_user_list) : collect();
                            $lims_user_list = $lims_user_list->filter(function ($u) {
                                return $u->id != \Auth::user()->id && ($u->is_active ?? true);
                            });
                            ?>
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        // Use variables provided by composer. Fallback to empty collections if not set.
                        $lims_expense_category_list = isset($lims_expense_category_list) ? collect($lims_expense_category_list) : collect();
                        $lims_warehouse_list = isset($lims_warehouse_list) ? collect($lims_warehouse_list) : collect();
                        // If user has restricted warehouse, filter accordingly
                        if (Auth::user()->role_id > 2) {
                            $lims_warehouse_list = $lims_warehouse_list->filter(function ($w) {
                                return $w->id == Auth::user()->warehouse_id;
                            });
                        }
                        $lims_account_list = isset($lims_account_list) ? collect($lims_account_list) : collect();
                        ?>
                        <div class="row">
                            <div class="col-md-6 form-group">
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $lims_income_category_list = isset($lims_income_category_list) ? collect($lims_income_category_list) : collect();
                        // Reuse $lims_warehouse_list and $lims_account_list from composer
                        $lims_warehouse_list = isset($lims_warehouse_list) ? collect($lims_warehouse_list) : collect();
                        if (Auth::user()->role_id > 2) {
                            $lims_warehouse_list = $lims_warehouse_list->filter(function ($w) {
                                return $w->id == Auth::user()->warehouse_id;
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $lims_biller_list = isset($lims_biller_list) ? collect($lims_biller_list) : collect();
                        ?>
                        <div class="form-group">
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $lims_customer_list = isset($lims_customer_list) ? collect($lims_customer_list) : collect();
                        ?>
                        <div class="form-group">
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $lims_customer_group_list = isset($lims_customer_group_list) ? collect($lims_customer_group_list) : collect();
                        ?>
                        <div class="form-group">
            ...
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <?php
                        $lims_supplier_list = isset($lims_supplier_list) ? collect($lims_supplier_list) : collect();
                        ?>
                        <div class="form-group">
