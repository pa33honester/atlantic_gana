                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <div class="input-group pos">                                            
                                            <select id="supplier_id" name="supplier_id" required class="selectpicker form-control" data-live-search="true" title="This field is required.">
                                                @foreach($lims_supplier_list as $supplier)
                                                <option value="{{$supplier->id}}" data-supname="{{$supplier->name}}">{{$supplier->name .' ('. $supplier->company_name .')'}}</option>
                                                @endforeach
                                            </select>
                                            <input type="hidden" name="supplier_name">
                                            <button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target="#addSupplier"><i class="dripicons-plus"></i></button>
                                        </div>
                                        <span class="validation-msg"></span>
                                        </div>
                                </div>
                                                  ...
                                                  <select class="form-control selectpicker" name="unit_id">
                                                    ...
                                                    @foreach($lims_unit_list as $unit)
                                                        @if($unit->base_unit==null)
                                                            <option value="{{$unit->id}}" <?php if($unit->id == 1){ ?>selected<?php } ?>>{{$unit->unit_name}}</option>
                                                        @endif
                                                    @endforeach
                                                  </select>
                                              </div>
                                ...
                                <div id="cost" class="col-md-4 hidden">
                                     <div class="form-group">
                                        ...
                                        <input type="number" name="cost" required class="form-control" step="any" value="100">
                                        <span class="validation-msg"></span>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4 hidden">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="wholesale_price" class="form-control" step="any" value="100">
                                    </div>
                                </div>
                                <div class="col-md-4 hidden">
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tax_id" class="selectpicker form-control" style="width: 100px">
                                            ...
                                            @foreach($lims_tax_list as $tax)
                                                <option value="{{$tax->id}}" <?php if($tax->id == 1){ ?>selected<?php } ?>>{{$tax->name}}</option>
                                            @endforeach
                                        </select>
              ...
              {!! Form::open(['route' => 'supplier.store', 'method' => 'post', 'files' => true]) !!}
                        <div class="row">                            
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-primary supplier-submit-btn">{{trans('file.submit')}}</button>
                                </div>
                            </div>
                        </div>
            {{ Form::close() }}
