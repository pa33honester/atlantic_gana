...
@section('content')
    <section class="forms">
                            ...
                            <form id="product-form">
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group pos">
                                                ...
                                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal"
                                                    data-target="#addSupplier"><i class="dripicons-plus"></i></button>
                                            </div>
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                                ...
                                                <select name="brand_id" class="selectpicker form-control"
                                                    ...
                                                    @foreach ($lims_brand_list as $brand)
                                                        <option value="{{ $brand->id }}"
                                                            <?php if($brand->id == 1){ ?>selected<?php } ?>>
                                                            {{ $brand->title }}</option>
                                                    @endforeach
                                                </select>
                                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal"
                                                    data-target="#addBrand"><i class="dripicons-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6" hidden>
                                                ...
                                                <select name="category_id" required class="selectpicker form-control"
                                                    ...
                                                    @foreach ($lims_category_list as $category)
                                                        <option value="{{ $category->id }}"
                                                            <?php if($category->id == 1){ ?>selected<?php } ?>>
                                                            {{ $category->name }}</option>
                                                    @endforeach
                                                </select>
                                                <div class="input-group-append">
                                                    <button type="button" class="btn btn-default btn-sm category-model"
                                                        data-toggle="modal" data-target="#category-modal"><i
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control selectpicker" name="sale_unit_id">
                                                        <option value="1" selected>SALE_UNIT_ID</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control selectpicker" name="purchase_unit_id">
                                                            <option value="1" selected>PURCHASE_UNIT_ID</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required name="width" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required name="length" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" required name="height" class="form-control"
                                                step="any">
                                            <span class="validation-msg"></span>
                                        </div>
                                    </div>
                                            ...
                                            <div class="input-group pos">
                                                ...
                                                <select name="tax_id" class="selectpicker form-control"
                                                    ...
                                                    @foreach ($lims_tax_list as $tax)
                                                        <option value="{{ $tax->id }}"
                                                            <?php if($tax->id == 1){ ?>selected<?php } ?>>
                                                            {{ $tax->name }}</option>
                                                    @endforeach
                                                </select>
                                                <button type="button" class="btn btn-default btn-sm" data-toggle="modal"
                                                    data-target="#addTax"><i class="dripicons-plus"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @if (\Schema::hasColumn('products', 'woocommerce_product_id'))
                                        <div class="col-md-12 mt-3">
                                            <h5><input name="is_sync_disable" type="checkbox" id="is_sync_disable"
                                                    value="1">&nbsp; {{ trans('file.Disable Woocommerce Sync') }}
                                            </h5>
                                        </div>
                                    @endif
                                    ...
                                    @if (in_array('ecommerce', explode(',', $general_setting->modules)))
                                        <div class="col-md-12 mt-3">
                                            <h5><input name="is_online" type="checkbox" id="is_online" value="1"
                                                    checked>&nbsp; {{ trans('file.Sell Online') }}</h5>
                                        </div>
                                        <div class="col-md-12 mt-3">
                                            <h5><input name="in_stock" type="checkbox" id="in_stock" value="1"
                                                    checked>&nbsp; {{ trans('file.In Stock') }}</h5>
                                        </div>
                                        <div class="col-md-12 mt-3 track_inventory" style="display:none">
                                            <h5><input name="track_inventory" type="checkbox" id="track_inventory"
                                                    value="0">&nbsp; {{ trans('file.Track Inventory') }}</h5>
                                        </div>
                                    @endif
                                </div>
                                @if (in_array('ecommerce', explode(',', $general_setting->modules)))
                                ...
                                <div class="form-group mt-3">
                                    <button type="submit" id="submit-btn"
                                        class="btn btn-primary">{{ trans('file.add_product') }}</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <!-- add customer modal -->
        <div id="addSupplier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
            class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    {!! Form::open(['route' => 'supplier.store', 'method' => 'post', 'files' => true, 'id' => 'supplier-form']) !!}
                    <div class="modal-header">
                        <h5 id="exampleModalLabel" class="modal-title">{{ trans('file.Add Supplier') }}</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group mt-4">
                                    ...
                                    <button type="button"
                                        class="btn btn-primary supplier-submit-btn">{{ trans('file.submit') }}</button>
                                </div>
                            </div>
                        </div>
                        {{ Form::close() }}
                    </div>
                    <div id="supplier-response"></div>
                </div>
            </div>
            <!-- Brand Create Modal Start -->
            <div id="addBrand" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        <form id="brand-form">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <button type="button"
                                        class="btn btn-primary brand-submit-btn">{{ trans('file.submit') }}</button>
                                </div>
                            </div>
                        </form>
                    </div>
            ...
            <div id="addTax" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
                class="modal fade text-left">
                <div role="document" class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form>
                                ...
                                <input type="hidden" name="ajax" value="1">
                                <button type="button"
                                    class="btn btn-primary tax-submit-btn">{{ trans('file.submit') }}</button>
                            </form>
                        </div>
                        {{ Form::close() }}
                    </div>
...
@push('scripts')
    <script type="text/javascript">
                ...
                $.ajax({
                    ...
                    success: function(responseData) {
                        ...
                        if (flag) {
                            ...
                            cols +=
                                '<td><input type="number" class="form-control unit_cost" value="' +
                                data[10] + '"/></td>';
                            cols +=
                ...
                $('#submit-btn').on("click", function(e) {
                    ...
                    if ($("#product-form").valid() && validate()) {
                        $('#submit-btn').attr('disabled', 'true').html(
                            '<span class="spinner-border text-light" role="status"></span> {{ trans('file.Saving') }}...'
                        );
                        tinyMCE.triggerSave();
                        if (myDropzone.getAcceptedFiles().length) {
                            ...
                            $.ajax({
                                ...
                                error: function(response) {
                                    ...
                                    $('#submit-btn').attr('enabled', 'true').html(
        ...
        $('.supplier-submit-btn').on("click", function() {
            $.ajax({
                type: 'POST',
                url: '{{ route('supplier.store') }}',
                data: $("#supplier-form").serialize(),
                success: function(response) {
                    //$("#supplier-response").html(response);
                    key = response['id'];
                    value = response['title'];
                    $('select[name="supplier_id"]').append('<option value="' + key + '">' + value +
                        '</option>');
                    $('select[name="supplier_id"]').val(key);
                    $('.selectpicker').selectpicker('refresh');
        ...
        $('.category-submit-btn').on("click", function() {
            $.ajax({
                ...
                success: function(response) {
                    key = response['id'];
                    value = response['name'];
                    $('select[name="category_id"]').append('<option value="' + key + '">' + value +
                        '</option>');
        ...
        $('.tax-submit-btn').on("click", function() {
            $.ajax({
                ...
                success: function(response) {
                    key = response['id'];
                    value = response['name'];
                    $('select[name="tax_id"]').append('<option value="' + key + '">' + value +
                        '</option>');
