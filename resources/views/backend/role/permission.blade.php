						            	...
						            	<span>
								            <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="unpaid" name="unpaid" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="unpaid" name="unpaid">
							                    	@endif
								                    <label for="unpaid" class="padding05">Unpaid &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
                          <span>
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="confirmed" name="confirmed" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="confirmed" name="confirmed">
							                    	@endif
								                    <label for="confirmed" class="padding05">Confirmed &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
						            		<div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="receiving" name="receiving" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="receiving" name="receiving">
							                    	@endif
								                    <label for="receiving" class="padding05">Receiving &nbsp;&nbsp;</label>
								                </div>
								            </div>
						            	</span>
						            	<span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="shipped" name="shipped" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="shipped" name="shipped">
							                    	@endif
								                    <label for="shipped" class="padding05">Shipped &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="signed" name="signed" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="signed" name="signed">
							                    	@endif
								                    <label for="signed" class="padding05">Signed &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="refunded" name="refunded" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="refunded" name="refunded">
							                    	@endif
								                    <label for="refunded" class="padding05">Refunded &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="cancelled" name="cancelled" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="cancelled" name="cancelled">
							                    	@endif
								                    <label for="cancelled" class="padding05">Cancelled &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						                <span>
						                    <div aria-checked="false" aria-disabled="false">
								                <div class="checkbox">
							                    	...
							                    	<input type="checkbox" value="1" id="returned" name="returned" checked>
							                    	@else
							                    	<input type="checkbox" value="1" id="returned" name="returned">
							                    	@endif
								                    <label for="returned" class="padding05">Returned &nbsp;&nbsp;</label>
								                </div>
								            </div>
						                </span>
						            </td>
