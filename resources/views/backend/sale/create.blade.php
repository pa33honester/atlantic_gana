                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hidden">
                                        <div class="form-group">
                                            ...
                                            <select name="currency_id" id="currency" class="form-control selectpicker" data-toggle="tooltip" title="" data-original-title="Sale currency">
                                                ...
                                                <option value="{{$currency_data->id}}" data-rate="{{$currency_data->exchange_rate}}" <?php if($currency_data->id == 1){ ?>selected<?php } ?>>{{$currency_data->code}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-2 hidden">
                                        ...
                                        <div class="form-group d-flex">
                                            ...
                                            <input class="form-control" type="text" id="exchange_rate" name="exchange_rate" value="1">
                                    ...
                                    <div class="col-md-4 hidden">
                                        <div class="form-group">
                                            ...
                                            <select name="sale_status" class="form-control">
                                                ...
                                                <option value="4">{{trans('Returned')}}</option>
...
function calculateRowProductData(quantity) {
    if(product_type[pos] == 'standard')
        ...
        row_product_price = product_price;
    ...
    var net_unit_price = product_price; // - product_discount[rowindex]; @dorian
    var tax = 0;
