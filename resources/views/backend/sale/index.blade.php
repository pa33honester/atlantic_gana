...
@section('content')
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="daterangepicker-field form-control"
                                    value="{{ $starting_date }} ~ {{ $ending_date }}" required />
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-info btn-sale btn-0">
                                        <input type="radio" name="sale_status" value="0"
                                            onchange="make_active(this.value)"> All
                                    </label>
                                    <label class="btn btn-info btn-sale btn-6">
                                        <input type="radio" name="sale_status" value="6"
                                            onchange="make_active(this.value)"> Unpaid
                                    </label>
                                    <label class="btn btn-info btn-sale btn-7">
                                        <input type="radio" name="sale_status" value="7"
                                            onchange="make_active(this.value)"> Confirmed
                                    </label>
                                    <label class="btn btn-info btn-sale btn-12">
                                        <input type="radio" name="sale_status" value="12"
                                            onchange="make_active(this.value)"> Receiving
                                    </label>
                                    <label class="btn btn-info btn-sale btn-8">
                                        <input type="radio" name="sale_status" value="8"
                                            onchange="make_active(this.value)"> Shipped
                                    </label>
                                    <label class="btn btn-info btn-sale btn-9">
                                        <input type="radio" name="sale_status" value="9"
                                            onchange="make_active(this.value)"> Signed
                                    </label>
                                    <label class="btn btn-info btn-sale btn-14">
                                        <input type="radio" name="sale_status" value="14"
                                            onchange="make_active(this.value)"> Returned Receiving
                                    </label>
                                    <label class="btn btn-info btn-sale btn-4">
                                        <input type="radio" name="sale_status" value="4"
                                            onchange="make_active(this.value)"> Returned
                                    </label>
                                    <label class="btn btn-info btn-sale btn-11">
                                        <input type="radio" name="sale_status" value="11"
                                            onchange="make_active(this.value)"> Cancelled
                                    </label>
                                </div>
                            </div>
                        </div>
            ...
            <table id="sale-table" class="table sale-list" style="width: 100%">
                ...
                <tfoot class="tfoot active">
                    ...
                    <th style="width:100px !important;">
                        <button id="print-waybill-btn" class="btn btn-danger" style="display:none;">Print
                            Waybill</button>
                    </th>
                </tfoot>
            </table>
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="container mt-3 pb-2 border-bottom">
                    <div class="row">
                        <div class="col-md-6 d-print-none">
                            <button type="button" class="btn btn-default btn-sm btn-print"
                                data-print-target="#sale-details"><i class="dripicons-print"></i>
                                {{ trans('file.Print') }}</button>

                            {{ Form::open(['route' => 'sale.sendmail', 'method' => 'post', 'class' => 'sendmail-form']) }}
                            <input type="hidden" name="sale_id">
                            <button id='email-btn' class="btn btn-default btn-sm d-print-none"><i
                ...
                <div class="modal-footer d-flex">
                    <a class="tracking_code" href="https://www.speedaf.com/cn-en" target="_blank"></a>
                    <button type="button" class="btn btn-rounded btn-md btn-success d-print-none ml-auto"
    ...
    <div id="confirm-print" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="container mt-3 pb-2 border-bottom">
                    <div class="row">
                        <div class="col-md-6 d-print-none">
                            <button type="button" class="btn btn-default btn-sm btn-print"
                                data-print-target="#confirm-print"><i class="dripicons-print"></i>
                                {{ trans('file.Print') }}</button>
                        </div>
                        <div class="col-md-6 d-print-none">
                            <button type="button" id="close-btn" data-dismiss="modal" aria-label="Close"
                ...
                <div class="modal-footer">
                    <button id="btn-delivery" type="submit" class="btn btn-rounded btn-md btn-success d-print-none">
                        Deliver </button>
                </div>
            </div>
        </div>
    ...
    <style id="img-pop-up-style">
        #imageModal {
            ...
            /* Higher than the original modal */
        }
    ...
    <div id="update-status" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 form-group">
                            <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                <label class="btn btn-success active">
                                    <input type="radio" name="res_type" id="confirm" value="confirm"
                                        onchange="order_reason(this.id);reset_validation('input', 'res_type');" checked>
                                    Confirm Order
                                </label>
                                <label class="btn btn-danger">
                                    <input type="radio" name="res_type" id="cancel" value="cancel"
                                        onchange="order_reason(this.id);reset_validation('input', 'res_type');"> Cancel
                                    Order
                                </label>
                                <label class="btn btn-warning">
                                    <input type="radio" name="res_type" id="report" value="report"
                                        onchange="order_reason(this.id);reset_validation('input', 'res_type');"> Report
                                    Order
                                </label>
                            </div>
                        </div>
                        <div class="col-md-12 form-group" id="res_reason_1">
                            ...
                            <select name="res_reason_1" required class="form-control selectpicker"
                                onchange="reset_validation('select', 'res_reason_1');">
                        ...
                        <div class="col-md-12 form-group" id="res_reason_2">
                            ...
                            <div class="d-flex flex-row gap-3" style="gap: 2rem;">
                                <div class="form-check form-check-inline"
                                    ...
                                    <input class="form-check-input" type="radio" name="res_reason_2"
                                        id="reason_no_answer" value="No-Answer" required
                                        onchange="reset_validation('select', 'res_reason_2');$('#call_on_date_picker').addClass('d-none');">
                                    <label class="form-check-label ml-2" for="reason_no_answer"
                                        style="margin-left: 0.5rem;">{{ trans('No Answer') }}</label>
                                </div>
                                <div class="form-check form-check-inline"
                                    style="display: flex; align-items: center; margin-right: 2rem;">
                                    <input class="form-check-input" type="radio" name="res_reason_2"
                                        id="reason_switched_off" value="Switch-Off"
                                        onchange="reset_validation('select', 'res_reason_2');$('#call_on_date_picker').addClass('d-none');">
                                    <label class="form-check-label ml-2" for="reason_switched_off"
                                        style="margin-left: 0.5rem;">{{ trans('Switched Off') }}</label>
                                </div>
                                <div class="form-check form-check-inline" style="display: flex; align-items: center;">
                                    <input class="form-check-input" type="radio" name="res_reason_2"
                                        id="reason_call_on" value="Call-On"
                                        onchange="reset_validation('select', 'res_reason_2');$('#call_on_date_picker').removeClass('d-none');">
                                    <label class="form-check-label ml-2" for="reason_call_on"
                                        style="margin-left: 0.5rem;">{{ trans('Call On') }}</label>
                                </div>
                                <div class="form-check form-check-inline" style="display: flex; align-items: center;">
                                    <input class="form-check-input" type="radio" name="res_reason_2"
                                        id="reason_out_of_stock" value="Out-of-Stock"
                                        onchange="reset_validation('select', 'res_reason_2');$('#call_on_date_picker').addClass('d-none');">
                                    <label class="form-check-label ml-2" for="reason_out_of_stock"
                                        style="margin-left: 0.5rem;">{{ trans('Out-of-Stock') }}</label>
                                </div>
                            </div>
    ...
    <div id="update-status-filters" tabindex="-1" role="dialog" aria-labelledby="updateStatusFilters"
        ...
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    {!! Form::open([
                        'route' => 'sale.update-status-filters',
                        'method' => 'post',
                        'files' => true,
                        'class' => 'update_status_filters',
                    ]) !!}
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group text-left">
                            <button type="button"
                                class="btn btn-info update_status_filters_btn">{{ trans('file.submit') }}</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div id="update-shipping-fee" tabindex="-1" role="dialog" aria-labelledby="updateShippingFee" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    {!! Form::open([
                        ...
                        'method' => 'post',
                        'files' => true,
                        'class' => 'update_shipping_fee',
                    ]) !!}
                    <div class="row">
                        <div class="col-md-12">
                            <p class="ajax-status">Shipping Cost</p>
                        </div>
                        <div class="col-md-6 form-group text-left">
                            <input type="hidden" name="sale_id">
                            <input type="hidden" name="order_type">
                        ...
                        <div class="col-md-6 form-group text-left">
                            <button type="button"
                                class="btn btn-info update_shipping_fee_btn">{{ trans('file.submit') }}</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div id="return-ship" tabindex="-1" role="dialog" aria-labelledby="updateReturnShip" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <p class="ajax-status">Return Shipping Cost</p>
                        </div>
                        <div class="col-md-8 form-group text-left">
                            ...
                            <input type="text" class="form-control" id="tracking-code-input" name="tracking_code"
    ...
    <div id="cancel-order" tabindex="-1" role="dialog" aria-labelledby="orderCancel" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group text-left">
                            <button type="button"
                                class="btn btn-info order_cancel_btn">{{ trans('file.submit') }}</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div id="reset-order" tabindex="-1" role="dialog" aria-labelledby="orderReset" aria-hidden="true"
        class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group text-left">
                            <button type="button"
                                class="btn btn-info order_reset_btn">{{ trans('file.submit') }}</button>
                        </div>
                    </div>
                    {{ Form::close() }}
                </div>
    ...
    <div id="edit-sale" tabindex="-1" role="dialog" aria-labelledby="editSale" aria-hidden="true"
        class="modal fade text-left">
...
@push('scripts')
    <script type="text/javascript">
        ...
        function editx(id) {
            // Build edit URL using url() so it respects subdirectory / base path
            var salesBase = "{{ url('sales') }}"; // e.g. https://example.com/your-subdir/sales
            var editUrl = salesBase + '/' + id + '/edit';
            // Set iframe src and show modal
            $("#editSale").attr("src", editUrl);
            // attach handlers to help debug load failures
            $("#editSale").off('load').on('load', function() {
                // iframe loaded (could still be an error page, but at least the request succeeded)
                console.log('Edit iframe loaded:', editUrl);
                // Try to detect if the iframe returned an HTML error by checking content-type when possible
                try {
                    var iframeDoc = document.getElementById('editSale').contentDocument || document.getElementById(
                        'editSale').contentWindow.document;
                    var html = iframeDoc.documentElement.innerHTML;
                    // quick heuristic: if the content contains "Exception" or "<!DOCTYPE html>" near top and not the expected form, warn
                    if (/Exception|Stacktrace|Whoops|<\!DOCTYPE html>/i.test(html.substring(0, 800))) {
                        console.warn(
                            'Edit iframe seems to contain an error page or HTML document; opening in new tab for inspection.'
                        );
                        window.open(editUrl, '_blank');
                    }
                } catch (e) {
                    // cross-origin or access denied — open in new tab so user can inspect
                    console.warn(
                        'Unable to inspect iframe content (cross-origin or denied). Opening edit URL in a new tab for debugging.'
                    );
                    window.open(editUrl, '_blank');
                }
            }).off('error').on('error', function() {
                console.error('Failed to load edit iframe (network or server error):', editUrl);
                // Open the URL in a new tab so the browser shows the raw error/stacktrace and headers
                window.open(editUrl, '_blank');
            });
        ...
        function saleDetails(sale) {
            ...
            $('#sale-details .tracking_code').html(sale['tracking_code'] ?
                `Tracking Code : <code>${sale['tracking_code']}</code>` : '');
        ...
        $(document).ready(function() {
                            ...
                            success: function(response) {
                                ...
                                if (response.code == 200) {
                                    ...
                                    const audio = new Audio(
                                        '/sounds/success-scan.mp3'); // Adjust path as needed
            ...
            $(document).ready(function() {
                $(".tracking_code").on("click", function() {
                    let trackingCode = $(this).find("code").text().trim();
                    if (trackingCode)
