...
<script type="text/javascript">
    ...
    var columns = [{"data": "key"}, {"data": "reference_no"}, {"data": "product_name"}, {"data": "product_code"},{"data": "sale_status"}, {"data": "item"}, {"data": "grand_total"}, {"data": "shipping"}, {"data": "paid_amount"}, {"data": "due"}, {"data": "customer"}, {"data": "customer_address"}, {"data": "date"}, {"data": "updated_date"}];
    ...
    function datatable_sum(dt_selector, is_calling_first) {
        if (dt_selector.rows( '.selected' ).any() && is_calling_first) {
            ...
            $( dt_selector.column( 5 ).footer() ).html(dt_selector.cells( rows, 5, { page: 'current' } ).data().sum().toFixed());
