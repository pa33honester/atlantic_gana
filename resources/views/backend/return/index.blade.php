                ...
                <div class="row m-2 align-items-end">
                    <div class="col-lg-2 col-md-3 mb-2">
                        ...
                        <div class="input-group">
                            <input id="date-range" type="text" class="daterangepicker-field form-control"
                    ...
                    <div class="col-lg-2 col-md-3 mb-2">
                        ...
                        <select id="supplier-id" class="form-control selectpicker" name="supplier_id"
                    ...
                    <div class="col-lg-2 col-md-3 mb-2">
                        ...
                        <select id="product_code" class="form-control selectpicker" name="product_code"
                            data-live-search="true">
...
@push('scripts')
    <script type="text/javascript">
        ...
        function returnDetails(returns) {
            ...
            var htmltext = '<strong>{{ trans('file.Date') }}: </strong>' + returns[0] +
                ...
                '<br><strong>{{ trans('file.Sale Reference') }}: </strong>' + returns[24] +
                '<br><strong>{{ trans('file.Warehouse') }}: </strong>' + returns[2] +
                '<br><strong>{{ trans('file.Currency') }}: </strong>' + returns[26];
            if (returns[27])
            ...
            if (returns[25])
                htmltext += '<strong>{{ trans('file.Attach Document') }}: </strong><a href="documents/sale_return/' +
                returns[25] + '">Download</a><br>';
            htmltext += '<br><div class="row"><div class="col-md-6"><strong>{{ trans('file.From') }}:</strong><br>' +
                returns[3] + '<br>' + returns[4] + '<br>' + returns[5] + '<br>' + returns[6] + '<br>' + returns[7] +
                '<br>' + returns[8] +
    ...
    <script>
        ...
        let isClickedUpdateStatus = false;
        $(".update_status_btn").on("click", function() {
            if (isClickedUpdateStatus) {
                return;
            }

            isClickedUpdateStatus = true;
