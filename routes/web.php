...
Route::group(['middleware' => ['common', 'auth', 'active']], function () {
    ...
    // AJAX endpoint for user search (Select2)
    Route::get('users/search', [App\Http\Controllers\UserSearchController::class, 'search'])->name('users.search');
    ...
    Route::controller(SaleController::class)->group(function () {
        ...
        Route::get('sales/updatestatus', 'updateStatus')->name('sale.update-status');
        Route::post('sales/updatestatus', 'updateStatus')->name('sale.update-status');
        Route::get('sales/updatestatusfilters', 'updateStatusFilters')->name('sale.update-status-filters');
        Route::post('sales/updatestatusfilters', 'updateStatusFilters')->name('sale.update-status-filters');
