        ...
        if(!empty($sales))
        {
            foreach ($sales as $key=>$sale)
            {
                ...
                elseif($sale->sale_status == 6){
                    $nestedData['sale_status'] = '<div class="badge badge-info">'.trans('Unpaid').'</div>';
                    $sale_status = trans('Unpaid');
                }
                elseif($sale->sale_status == 7){
                    $nestedData['sale_status'] = '<div class="badge badge-info">'.trans('Confirmed').'</div>';
                    $sale_status = trans('Confirmed');
                }
                elseif($sale->sale_status == 8){
                    $nestedData['sale_status'] = '<div class="badge badge-info">'.trans('Delivered').'</div>';
                    $sale_status = trans('Delivered');
                }
                ...
                elseif($sale->sale_status == 10){
                    $nestedData['sale_status'] = '<div class="badge badge-info">'.trans('Refunded').'</div>';
                    $sale_status = trans('Refunded');
                }
                elseif($sale->sale_status == 11){
                    $nestedData['sale_status'] = '<div class="badge badge-info">'.trans('Cancelled').'</div>';
